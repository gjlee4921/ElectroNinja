...
def circuit_saver(original_asc_file):
    ...
    print(f"📂 Created timestamped directory: {output_directory}")
...
circuit_saver(r"C:\Users\vleou\OneDrive\Cambridge\LTSpite_Agent\2paraller.asc")